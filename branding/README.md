...
### Wordmark
<img src="wordmark-src.svg" width="600" />
...
|--------|------|-----|-------|
| ![](https://placehold.co/72x32/E6F1FB/E6F1FB) | Blue 50 | `#E6F1FB` | Backgrounds, highlights, hover surfaces |
| ![](https://placehold.co/72x32/B5D4F4/B5D4F4) | Blue 100 | `#B5D4F4` | Light fills, disabled states |
| ![](https://placehold.co/72x32/85B7EB/85B7EB) | Blue 200 | `#85B7EB` | Secondary accents, icon fills |
| ![](https://placehold.co/72x32/378ADD/378ADD) | Blue 400 | `#378ADD` | Mid-tone, chart elements |
| ![](https://placehold.co/72x32/185FA5/185FA5) | Blue 600 | `#185FA5` | **Brand blue** — buttons, links, focus rings |
...
| Swatch | Name | Hex | Usage |
|--------|------|-----|-------|
| ![](https://placehold.co/72x32/E1F5EE/E1F5EE) | Teal 50 | `#E1F5EE` | Success backgrounds, tag surfaces |
| ![](https://placehold.co/72x32/9FE1CB/9FE1CB) | Teal 100 | `#9FE1CB` | Light fills |
| ![](https://placehold.co/72x32/5DCAA5/5DCAA5) | Teal 200 | `#5DCAA5` | Icon fills, secondary chart series |
| ![](https://placehold.co/72x32/1D9E75/1D9E75) | Teal 400 | `#1D9E75` | **Teal accent** — badges, chart bars, icons |
...
| Swatch | Name | Hex | Usage |
|--------|------|-----|-------|
| ![](https://placehold.co/72x32/FAEEDA/FAEEDA) | Amber 50 | `#FAEEDA` | Warning backgrounds, callout surfaces |
| ![](https://placehold.co/72x32/FAC775/FAC775) | Amber 100 | `#FAC775` | Light fills |
| ![](https://placehold.co/72x32/EF9F27/EF9F27) | Amber 200 | `#EF9F27` | **Amber accent** — highlights, alert icons |
| ![](https://placehold.co/72x32/BA7517/BA7517) | Amber 400 | `#BA7517` | Mid-tone |
| ![](https://placehold.co/72x32/854F0B/854F0B) | Amber 600 | `#854F0B` | Borders on amber surfaces |
...
| Swatch | Name | Hex | Usage |
|--------|------|-----|-------|
| ![](https://placehold.co/72x32/F1EFE8/F1EFE8) | Gray 50 | `#F1EFE8` | Page background (light mode) |
| ![](https://placehold.co/72x32/D3D1C7/D3D1C7) | Gray 100 | `#D3D1C7` | Dividers, subtle borders |
| ![](https://placehold.co/72x32/B4B2A9/B4B2A9) | Gray 200 | `#B4B2A9` | Disabled text, placeholder text |
| ![](https://placehold.co/72x32/888780/888780) | Gray 400 | `#888780` | Secondary text, icons |
...
|--------|------|-----| ----- |
| ![](https://placehold.co/72x32/0E1621/0E1621) | Page background | `#0E1621` | Deep blue-tinted dark |
| ![](https://placehold.co/72x32/0A1019/0A1019) | Surface / card | `#0A1019` | Slightly darker than page bg |
| ![](https://placehold.co/72x32/1E2D42/1E2D42) | Border | `#1E2D42` | Subtle blue-tinted border |
| ![](https://placehold.co/72x32/C8DDF0/C8DDF0) | Body text | `#C8DDF0` | Desaturated light blue — easier on the eyes than pure white |
| ![](https://placehold.co/72x32/4A6A8A/4A6A8A) | Muted text | `#4A6A8A` | Mid-range blue-gray |
| ![](https://placehold.co/72x32/185FA5/185FA5) | Brand blue (dark) | `#185FA5` | Same as light mode — holds up well on dark surfaces |
